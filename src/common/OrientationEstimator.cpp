...
void CheaterOrientationEstimator::run()
{
    ...
    this->_stateEstimatorData.result->omegaBody(0) = this->_stateEstimatorData.lowState->imu.gyroscope[0];
    this->_stateEstimatorData.result->omegaBody(1) = this->_stateEstimatorData.lowState->imu.gyroscope[1];
    this->_stateEstimatorData.result->omegaBody(2) = this->_stateEstimatorData.lowState->imu.gyroscope[2];
